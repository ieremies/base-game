...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(
        ...
        self.speed = [0.0, 0.0]  # medido em pixels por segundo
        self.max_speed = 5  # módulo máximo da velocidade
        self.move_acceleration = (3, 3)  # aceleração causada pelo input de movimento
        self.friction = 0.9  # coeficiente de fricção

        self.forces = []  # lista de forças de campo que atuam sobre o jogador
